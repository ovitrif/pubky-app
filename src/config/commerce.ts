...
export const COMMERCE_SHOP_MAX_COLLECTIONS = 12;
export const COMMERCE_SHOP_COLLECTION_NAME_MAX_CHARS = 60;
export const COMMERCE_SHOP_COLLECTION_MAX_LISTINGS = 48;
